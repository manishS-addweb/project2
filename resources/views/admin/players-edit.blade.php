            ...
            <div class="card-body">
                <form action="{{ route('players.update',$player->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="price" id="price" class="form-control" value="{{$player->price}}" required>
                    </div>
                    <div class="form-group">
                        ...
                        <select  id="" class="form-control" name="category_id">
                            ...
                            @foreach($categories as $category)
                                <option {{$category->id==$player->category_id ? 'selected': ''}} value="{{$category->id}}">{{$category->name}}</option>
                            @endforeach
                        </select>
                    </div>
