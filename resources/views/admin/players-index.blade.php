    ...
    <main class="main-content mt-5">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6">
                        <h4>Players Listing</h4>
                    </div>
                    <div class="col-md-6 d-flex justify-content-end">
                        <a class="btn btn-success mx-1" href="{{route('create.players')}}">Add Player</a>
                ...
                <table class="table table-striped table-bordered border-dark ">
                    ...
                    @foreach($players as $player)
                        <tr>
                            ...
                            <td >
                                <div class="d-flex">
                                    <a class="btn-sm btn-primary btn" href="{{route('players.edit',$player->id)}}">edit</a>
